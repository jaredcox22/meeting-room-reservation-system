...
const MOCK_SCHEDULES: Record<string, Meeting[]> = {
  canvass: [
    {
      id: "c1",
...
export function getMockSchedule(roomSlug: string): Meeting[] {
  return MOCK_SCHEDULES[roomSlug] ?? [];
}
